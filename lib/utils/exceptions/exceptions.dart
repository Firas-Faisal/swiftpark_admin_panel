...
class SAPExceptions implements Exception {
  ...
  factory SAPExceptions.fromCode(String code) {
    switch (code) {
      case 'email-already-in-use':
        return const SAPExceptions(
      ...
      case 'user-not-found':
        return const SAPExceptions('Invalid login details. User not found.');
      case 'wrong-password':
        return const SAPExceptions(
      ...
      case 'invalid-password':
        return const SAPExceptions('Incorrect password. Please try again.');
      case 'invalid-phone-number':
        return const SAPExceptions('The provided phone number is invalid.');
      ...
      case 'sign_in_failed':
        return const SAPExceptions('Sign-in failed. Please try again.');
      case 'network-request-failed':
        return const SAPExceptions(
            'Network request failed. Please check your internet connection.');
      case 'internal-error':
        return const SAPExceptions('Internal error. Please try again later.');
      ...
      case 'quota-exceeded':
        return const SAPExceptions('Quota exceeded. Please try again later.');
      default:
        return const SAPExceptions();
    }
  }
