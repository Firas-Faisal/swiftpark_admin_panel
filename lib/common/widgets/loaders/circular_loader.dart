...
class SAPCircularLoader extends StatelessWidget {
  ...
  const SAPCircularLoader({
    super.key,
    this.foregroundColor = SAPColors.white,
    this.backgroundColor = SAPColors.primary,
  });
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(SAPSizes.lg),
