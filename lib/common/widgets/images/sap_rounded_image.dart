...
class SAPRoundedImage extends StatelessWidget {
  const SAPRoundedImage({
    super.key,
    this.image,
    this.file,
    this.border,
    ...
    this.padding = SAPSizes.sm,
    this.margin,
    this.fit = BoxFit.contain,
    this.applyImageRadius = true,
    this.borderRadius = SAPSizes.md,
  });
    ...
    if (image != null) {
      ...
      return CachedNetworkImage(
        ...
        progressIndicatorBuilder: (context, url, downloadProgress) =>
            SAPShimmerEffect(width: width, height: height),
      );
    } else {
