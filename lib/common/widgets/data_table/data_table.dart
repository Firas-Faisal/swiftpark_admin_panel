...
class SAPDataTable extends StatelessWidget {
  const SAPDataTable({
    super.key,
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: DataTable2(
        ...
        headingRowColor:
            WidgetStateProperty.resolveWith((states) => SAPColors.primary),
        // Set the decoration for the data table
        decoration: const BoxDecoration(
          color: Colors.white,
          borderRadius:
              BorderRadius.all(Radius.circular(SAPSizes.borderRadiusMd)),
        ),
