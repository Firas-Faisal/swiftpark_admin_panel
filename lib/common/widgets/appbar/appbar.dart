...
class SAPAppBar extends StatelessWidget implements PreferredSizeWidget {
      ...
      leading: showBackArrow
          ? IconButton(
              ...
              icon: Icon(Iconsax.arrow_left,
                  color: dark ? SAPColors.white : SAPColors.dark))
          : leadingIcon != null
  ...
  @override
  Size get preferredSize => Size.fromHeight(SAPDeviceUtils.getAppBarHeight());
}
